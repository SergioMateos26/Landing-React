...
import imagen2 from '../img/persona.jpg'

function Equipo() {
  return (
        <div class="container col-12 agustar" >
            <div class="text-center equipo">
                <div class="col-xl-3 col-sm-3 mb-3 cuadrado">
                    <div class="blanco rounded shadow-sm py-5 px-4">
                        <img src={imagen2} alt="" width="150px" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"></img>
                        <h5 class="mb-0" >Sergio</h5><span class="small text-uppercase text-muted">CEO - Founder</span>
                        <ul class="social mb-0 list-inline mt-3">
                            <a className="iconos" href="#">
                ...
                <div class="col-xl-3 col-sm-3 mb-3 cuadrado">
                    <div class="blanco rounded shadow-sm py-5 px-4">
                        <img src={imagen2} alt="" width="150px" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"></img>
                    <h5 class="mb-0">Ametz</h5><span class="small text-uppercase text-muted">CEO - Founder</span>
                        <ul class="social mb-0 list-inline mt-3">
                            <a className="iconos" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 24 24">
                                    <path d="M 2.8671875 3 L 9.7363281 12.818359 L 2.734375 21 L 5.3808594 21 L 10.919922 14.509766 L 15.460938 21 L 21.371094 21 L 14.173828 10.697266 L 20.744141 3 L 18.138672 3 L 12.996094 9.0097656 L 8.7988281 3 L 2.8671875 3 z"></path>
                ...
                <div class="col-xl-3 col-sm-3 mb-3 cuadrado">
                    <div class="blanco rounded shadow-sm py-5 px-4">
                        <img src={imagen2} alt="" width="150px" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"></img>
                        <h5 class="mb-0" >Ane</h5><span class="small text-uppercase text-muted">CEO - Founder</span>
                        <ul class="social mb-0 list-inline mt-3">
                            <a className="iconos" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 24 24">
                                    <path d="M 2.8671875 3 L 9.7363281 12.818359 L 2.734375 21 L 5.3808594 21 L 10.919922 14.509766 L 15.460938 21 L 21.371094 21 L 14.173828 10.697266 L 20.744141 3 L 18.138672 3 L 12.996094 9.0097656 L 8.7988281 3 L 2.8671875 3 z"></path>
